...
var CONTENT = {
  onboarding: {
    ...
    si: {
      ...
      features: [
        ...
        { icon: 'chatbubble-ellipses-outline', text: 'ඔබේම පෞද්ගලික ජ්‍යෝතිෂී — 24/7',
    ...
    si: {
      ...
      features: [
        ...
        { icon: 'pulse-outline', text: 'සෞඛ්‍ය අවදානම් සහ ආයු කාලය',
          desc: 'ඔබේ ශරීරයේ දුර්වල ස්ථාන, ප්‍රවේසම් විය යුතු කාල සහ එය මඟහරවා ගන්නා විදිහ.' },
        ...
        { icon: 'download-outline', text: 'ජීවිත කාලයටම වැදගත් වන PDF වාර්තාව',
          desc: 'එක වරක් බාගත කර ඔබේ සහ දෙමාපියන්ගේ දුරකථනයේ තබාගන්න. ඕනෑම වෙලාවක කියවන්න.' },
      ],
  ...
  porondam: {
    ...
    si: {
      ...
      title: 'ඔවුන් ඔබටම\nහිමි කෙනාද?',
      subtitle: 'වසර 2,000ක් පැරණි සාම්ප්‍රදායික පරීක්ෂාව යොදාගෙන කොයිතරම් දුරට ඔබ දෙදෙනා ගැලපෙනවද කියලා තත්පර 30කින් හරියටම දකින්න.',
      stats: [
      ...
      features: [
        ...
        { icon: 'stats-chart-outline', text: 'ලකුණු 20න් සැබැ ගැලපීම',
          desc: 'කිසිම දෙයක් වසන් නොකර, ඔබ දෙදෙනාගේ අනාගතය කොතරම් සාර්තක ද කියලා.' },
        ...
        { icon: 'calendar-outline', text: 'විවාහයට හොඳම කාලය',
          desc: 'ඔබ දෙදෙනාටම විශේෂයෙන් තෝරා ගන්නා ලද වාසනාවන්තම දිනයන්.' },
        { icon: 'magnet-outline', text: 'ආකර්ෂණය සහ රසවිද්‍යාව',
          desc: 'ඔබ දෙදෙනා අතර ස්වාභාවික ආකර්ෂණය කොතරම් ප්‍රබලද කියලා දැනගන්න.' },
        { icon: 'sunny-outline', text: 'ඔබගේ ශක්ති කොටස්',
          desc: 'මුදල් වාසනාව, පවුල් සුවය, හැගීම් ගැලපීම — ඔබේ සබඳතාවේ හොඳම දෙයන්.' },
        { icon: 'grid-outline', text: 'දෙදෙනාගේම කේන්දරය',
          desc: 'ඔබ දෙදෙනාගේ සම්පූර්ණ ජාතක චක්‍ර — වැඩිහිටියන්ට පේන්වීමට හොඳයි.' },
        { icon: 'document-text-outline', text: 'සම්පූර්ණ ලියුම් වාර්තාව',
          desc: 'ඔබේ ගැලපීම ගැන සම්පූර්ණ විග්‍රහයක් — ජ්‍යෝතිෂී කෙනෙකු ලඟ ඉන්නා වගේ.' },
