// ═══════════════════════════════════════════════════════════════════════
//  BlueNebulaBg.js — Animated blue nebula background (pure Reanimated)
//  for the Kendara page. Pulsing blue/indigo/cyan nebula glows + stars.
//  Sits behind scrollable content below the 3D blue aurora.
// ═══════════════════════════════════════════════════════════════════════
...
// ── Tiny static star dots — cool blue/white ──
        ...
        return (
          <View
            ...
            style={{
              ...
              backgroundColor: 'rgba(160,200,255,0.85)',
              opacity: s.opacity,
            }}
          />
        );
...
export default function BlueNebulaBg() {
  ...
  // ── Large sapphire nebula — center-left ──
  ...
  // ── Deep indigo nebula — bottom-right ──
  ...
  // ── Subtle violet accent — lower-left ──
    ...
    >
      ...
      <Animated.View
        style={[{
          ...
          backgroundColor: 'rgba(30,80,200,0.18)',
        }, nebula1]}
      />
      ...
      <Animated.View
        style={[{
          ...
          backgroundColor: 'rgba(40,20,140,0.15)',
        }, nebula2]}
      />

      {/* Wide cyan haze — center spread */}
      <Animated.View
        style={[{
          position: 'absolute',
          top: SH * 0.12,
          ...
          backgroundColor: 'rgba(30,120,220,0.10)',
        }, nebula3]}
      />

      {/* Violet accent — lower-left */}
      <Animated.View
        style={[{
          position: 'absolute',
          bottom: SH * 0.06,
          ...
          height: SW * 0.60,
          borderRadius: SW * 0.30,
          backgroundColor: 'rgba(60,30,160,0.12)',
        }, nebula4]}
      />

      {/* Bright blue highlight — mid-right */}
      <Animated.View
        style={[{
          position: 'absolute',
          top: SH * 0.10,
          ...
          backgroundColor: 'rgba(20,100,240,0.09)',
        }, nebula1]}
      />
