...
var PRACTICAL_TONES = {
  start: {
    ...
    effectSi: 'විශ්වයෙන් අද ඔයාට අලුත් ආරම්භයක රහස් ගිනිපුපුරක් දෙනවා. තියන පුංචිම පියවර වුණත් අද මාරම ලස්සනට ගැලපිලා යයි.',
    dosEn: ['Start that one tiny thing', 'Trust your morning instinct'], dosSi: ['හිතේ තියන ඒ පුංචි වැඩේ අදම පටන්ගන්න', 'උදේම හිතට දැනෙන හැඟීම විශ්වාස කරන්න'],
    dontsEn: ['Overpromise everything', 'Scatter this precious energy'], dontsSi: ['හැමදේම කරන්නම් කියලා පොරොන්දු වෙන්න එපා', 'අද ලැබෙන විශේෂ ශක්තිය නිකරුණේ නාස්ති කරන්න එපා'],
  },
  build: {
    ...
    effectSi: 'හරිම ස්ථාවර, ආරක්ෂිත ශක්තියක් අද දවසේ හැංගිලා තියෙනවා. අද ඔයා අලුතින් කරන හෝ දිගටම කරගෙන යන හැමදේකටම රහස් ආශිර්වාදයක් ලැබෙනවා.',
    dosEn: ['Continue what you love', 'Add a simple brick to your goals'], dosSi: ['ඔයා ආදරය කරන වැඩේ දිගටම කරගෙන යන්න', 'අරමුණ වෙනුවෙන් පුංචි හරි දෙයක් අදත් එකතු කරන්න'],
    dontsEn: ['Rush for magic results', 'Skip the little loving details'], dontsSi: ['ඉක්මනින්ම මැජික් ප්‍රතිඵල බලාපොරොත්තු වෙන්න එපා', 'ආදරණීය පුංචි පුංචි විස්තර මඟහරින්න එපා'],
  },
  relationship: {
    effectEn: 'People matter more today. Kind words and cooperation can open doors.',
    effectSi: 'අද දවසේ සබඳතාවලට ලොකු බලයක් තියෙනවා. ආදරණීය වචනවලින් ගොඩක් දේවල් ලේසියෙන්ම දිනාගන්න පුළුවන් දවසක්.',
    dosEn: ['Repair a conversation', 'Ask for support'], dosSi: ['අමනාප වෙච්ච අය එක්ක කතා බහ කරන්න', 'ඕන වෙලාවට අනිත් අයගෙන් උදව් ඉල්ලන්න'],
    dontsEn: ['Win arguments', 'Take silence personally'], dontsSi: ['වාද කරලා දිනන්න හදනවට වඩා අනිත් අයව තේරුම් ගන්න', 'අනිත් අයගේ නිශ්ශබ්දතාවය වරදවා වටහාගන්න එපා'],
  },
  learn: {
    effectEn: 'Curiosity is stronger. This is useful for study, planning, messages, and decisions that need facts.',
    effectSi: 'අලුත් දේවල් හොයන්න, ඉගෙනගන්න හිතෙන තියුණු ශක්තියක් අද තියනවා. වැදගත් තීරණ ගන්න කලින් කරුණු හොයලා බලන්න හොඳම දවසක්.',
    dosEn: ['Research before acting', 'Write things down'], dosSi: ['වැඩක් කරන්න කලින් ඒ ගැන ටිකක් හොයලා බලන්න', 'මතක තියාගන්න ඕන දේවල් ලියාගන්න'],
    dontsEn: ['Assume too quickly', 'Skip verification'], dontsSi: ['නොදැන ඉක්මනට උපකල්පනය කරන්න යන්න එපා', 'හරි වැරැද්ද බලන එක මඟහරින්න එපා'],
  },
  clear: {
    effectEn: 'Small blockers may show up so you can remove them. Patience turns friction into progress.',
    effectSi: 'පොඩි පොඩි බාධා මතු වෙන්න පුළුවන්, හැබැයි ඒ හැමදේම ඉස්සරහට යන්න පාර හදාගන්නයි. ඉවසීමෙන් හිටියොත් ඒ බාධාම ජයග්‍රහණයක් වෙයි.',
    dosEn: ['Fix one problem first', 'Double-check plans'], dosSi: ['කලබල වෙන්නේ නැතුව එක ප්‍රශ්නයක් ඉස්සෙල්ලා විසඳගන්න', 'ඔයාගේ ප්ලෑන්ස් දෙපාරක් චෙක් කරන්න'],
    dontsEn: ['Rush launches', 'React emotionally'], dontsSi: ['අලුත් දේවල් කලබලෙන් පටන්ගන්න එපා', 'ප්‍රශ්න ආවම හැඟීම්වලට වහල් වෙන්න එපා'],
  },
  heal: {
    effectEn: 'Recovery and care are highlighted. Choose actions that restore your body, home, or peace of mind.',
    effectSi: 'අද දවස වෙන් වෙලා තියෙන්නේ සැනසීම වගේම සුවය වෙනුවෙන්. හිත් වේදනා, ඇඟේ අමාරුකම් මඟඇරගන්න හිතට සැනසිල්ලක් දෙන දේවල් කරන්න.',
    dosEn: ['Rest without guilt', 'Handle health basics'], dosSi: ['කිසිම පසුතැවීමක් නැතුව නිදහසේ විවේක ගන්න', 'සෞඛ්‍යය ගැන විශේෂයෙන් හිතන්න'],
    dontsEn: ['Push through exhaustion', 'Ignore discomfort'], dontsSi: ['මහන්සි හෝ අමාරුයි කියලා දැනෙද්දිත් බලෙන් වැඩ කරන්න යන්න එපා', 'ඇඟෙන් දෙන සංඥා නොසලකා හරින්න එපා'],
  },
  discipline: {
    effectEn: 'Responsibility is the winning path. Slow, clean work is stronger than dramatic moves.',
    effectSi: 'අද ජයග්‍රහණය තියෙන්නේ වගකීම සහ විනය ඇතුළේ. කලබලෙන් ලොකු දේවල් කරනවට වඩා හිමින්, පිළිවෙළට කරන වැඩවලින් සාර්ථක වෙන්න පුළුවන්.',
    dosEn: ['Keep promises', 'Finish a duty'], dosSi: ['දුන්නු පොරොන්දු අනිවාර්යයෙන්ම ඉටු කරන්න', 'භාරගත්ත වැඩක් අන්තිමටම ඉවර කරන්න'],
  ...
  action: {
    ...
    dontsEn: ['Pick fights', 'Make impulsive promises'], dontsSi: ['නොවැදගත් දේවලට ගැටුම් ඇතිකරගන්න එපා', 'හදිසියේ වාසි නැති පොරොන්දු දෙන්න යන්න එපා'],
  },
  focus: {
    effectEn: 'Deep work is favored. You may feel intense, so give that intensity a useful target.',
    effectSi: 'එක අරමුණකට හිත එකලස් කරගන්න අද මාරම ලේසියි. ඒ හින්දා හිතේ තියෙන ඒ තදබල ශක්තිය එක වැදගත් වැඩක් වෙනුවෙන් විතරක් පාවිච්චි කරන්න.',
    ...
    dontsEn: ['Multitask heavily', 'Overthink every signal'], dontsSi: ['එකපාර වැඩ ගොඩක් කරන්න ගිහින් හිත අවුල් කරගන්න එපා', 'හැම පොඩි දේම ගැන ඕනෑවට වඩා හිතන්න එපා'],
  },
  social: {
    ...
    dontsEn: ['Carry everything alone', 'Create mixed messages'], dontsSi: ['ඔක්කොම බර තනියම කරගහගන්න යන්න එපා', 'අනිත් අයට පටලැවෙන විදිහට කතා කරන්න එපා'],
  },
  creative: {
    effectEn: 'Design, beauty, and problem-solving get a lift. Make something cleaner or more useful.',
    effectSi: 'නිර්මාණශීලී අදහස් ලස්සනට ගලාගෙන එන දවසක්. ප්‍රශ්නයක් ලස්සනට විසඳගන්න හරි, අඩාල වෙලා තිබ්බ වැඩක් ලස්සනට ඉවර කරන්න හරි අද පුළුවන්.',
    ...
    dontsEn: ['Chase perfection', 'Spend for show'], dontsSi: ['සියයට සීයක්ම පර්ෆෙක්ට් වෙන්න ඕන කියලා හිරවෙන්න එපා', 'අනිත් අයට පේන්න අනවශ්‍ය විදිහට වියදම් කරන්න එපා'],
  },
  review: {
    effectEn: 'Hidden issues can become clearer. This is good for honest review and fixing root causes.',
    effectSi: 'මෙච්චර කල් හැංගිලා තිබුණ ප්‍රශ්න සහ ඇත්ත තත්ත්වයන් අද එළියට ඒවි. වැරදි හදාගෙන අලුත් තීරණවලට යන්න මේක හොඳම වෙලාවක්.',
    dosEn: ['Look beneath the surface', 'Clean up old mistakes'], dosSi: ['මතුපිටින් පේන දේට වඩා ගැඹුරට හිතලා බලන්න', 'පරණ වැරදි පිළිගෙන ඒවා හදාගන්න'],
    dontsEn: ['Blame quickly', 'Start sensitive talks late'], dontsSi: ['විස්තර විභාග කරන්නේ නැතුව අනිත් අයට බනින්න එපා', 'සංවේදී දේවල් කතා කරන එක රෑ වෙනකම් කල්දාන්න එපා'],
  },
  rest: {
    ...
    dosEn: ['Pause before choosing', 'Make space for quiet'], dosSi: ['ඕනම දෙයක් තෝරගන්න කලින් පොඩ්ඩක් නතර වෙන්න', 'නිදහසේ හුස්මගන්න පුළුවන් නිහඬ වෙලාවක් හදාගන්න'],
  ...
  complete: {
    ...
    effectSi: 'අවසන් කිරීමේ ශක්තිය අද හරිම ප්‍රබලයි. බාගෙට කරපු දේවල් ඉවර කරලා, ඊළඟ පියවරට ලෑස්ති වෙන්න අද දවස පාවිච්චි කරන්න.',
  ...
  caution: {
    ...
    dosEn: ['Delay risky starts', 'Check messages twice'], dosSi: ['අවදානම් වැඩ අලුතෙන් පටන් ගන්න එපා, කල් දාන්න', 'ඕනම මැසේජ් එකක් යවන්න කලින් දෙපාරක් කියවලා බලන්න'],
    dontsEn: ['Sign under pressure', 'Travel without planning'], dontsSi: ['කවුරුහරි බල කරනවා කියලා ගිවිසුම්වලට අත්සන් කරන්න එපා', 'හරි සැලසුමක් නැතුව හදිසි ගමන් යන්න එපා'],
  },
  money: {
    effectEn: 'Trade, budgets, and practical exchanges need attention. Clear value matters.',
    effectSi: 'සල්ලි ගනුදෙනු, වියදම් සහ අයවැය ගැන අද ටිකක් කල්පනාවෙන් ඉන්න ඕන දවසක්. හුවමාරු වෙන දේවල වටිනාකම පැහැදිලිද කියලා බලන්න.',
    dosEn: ['Review costs', 'Make fair deals'], dosSi: ['වියදම් වෙන විදිහ පොඩ්ඩක් කල්පනාවෙන් බලන්න', 'දෙපැත්තටම සාධාරණ වෙන ගනුදෙනු විතරක් කරන්න'],
    dontsEn: ['Buy from pressure', 'Hide money details'], dontsSi: ['ආසාවට හෝ බලකිරීමට යටවෙලා අනවශ්‍ය විදිහට සල්ලි විසි කරන්න එපා', 'මුදල් සම්බන්ධ විස්තර අනිත් අයගෙන් හංගන්න එපා'],
  },
  travel: {
    effectEn: 'Movement and flexibility are supported. Keep plans light enough to adjust.',
    effectSi: 'ගමන් බිමන්වලට සහ වෙනස්වීම්වලට අද විශ්වයෙන් ලොකු සහායක් ලැබෙනවා. වෙනස් කරන්න පුළුවන් වෙන විදිහට සැලසුම් හදාගන්න එක තමයි වටින්නේ.',
    dosEn: ['Leave extra time', 'Keep options open'], dosSi: ['ගමන් යද්දි අමතර කාලයක් අරගෙනම යන්න', 'හැමදේකටම වෙනත් විකල්පයක් හිතේ තියාගන්න'],
    dontsEn: ['Depend on one plan', 'Ignore weather or traffic'], dontsSi: ['එකම සැලසුමකට විතරක් හිරවෙලා ඉන්න එපා', 'කාලගුණය හෝ ට්‍රැෆික් ගැන හිතන්නේ නැතුව එළියට බහින්න එපා'],
  },
  confidence: {
  ...
  listen: {
    ...
    dosEn: ['Listen fully', 'Ask one good question'], dosSi: ['අනිත් අය කියන දේ සම්පූර්ණයෙන්ම අහගන්න', 'වැදගත්ම එක හොඳ ප්‍රශ්නයක් විතරක් අහන්න'],
    dontsEn: ['Interrupt too soon', 'Miss quiet signals'], dontsSi: ['අනිත් අයට කතා කරන්න නොදී මැදින් පනින්න එපා', 'වචන නැතුව දෙන සිග්නල් මඟහැරගන්න එපා'],
  },
  patience: {
    ...
    dosEn: ['Choose the long view', 'Stay consistent'], dosSi: ['කෙටි වාසිවලට වඩා දිගුකාලීන වාසි ගැන හිතන්න', 'කරන දේ අතරමඟ නවත්තන්නේ නැතුව දිගටම කරන්න'],
    dontsEn: ['Force answers', 'Give up too early'], dontsSi: ['උත්තර දෙන්න කියලා කාටවත් බල කරන්න යන්න එපා', 'ප්‍රතිඵල නැහැ කියලා ඉක්මනින් අතහැරලා දාන්න එපා'],
  },
  steady: {
    ...
    dosEn: ['Keep the basics strong', 'Work steadily'], dosSi: ['ඔයාගේ මූලික දේවල් හරියටම තියාගන්න', 'කලබලයක් නැතුව පාඩුවේ වැඩ ටික කරගන්න'],
    dontsEn: ['Create drama', 'Change plans without reason'], dontsSi: ['නැති ප්‍රශ්න මවලා ලොකු කරගන්න යන්න එපා', 'හේතුවක් නැතුව එකපාරට ප්ලෑන්ස් වෙනස් කරන්න එපා'],
  },
  release: {
    effectEn: 'Letting go is supported. Remove clutter, old tension, or a habit that drains you.',
    effectSi: 'අත්හැරීම තමයි අද දවසේ තේමාව. ඔයාගේ හිතට වද දෙන, ඔයාව වෙහෙස කරන දේවල් හරි පුරුදු හරි අතහැරලා දාන්න.',
    dosEn: ['Clear a space', 'End a stale loop'], dosSi: ['ඔයාගේ වටපිටාවයි හිතයි පිරිසිදු කරගන්න', 'කිසිම තේරුමක් නැති පරණ පුරුද්දකට තිත තියන්න'],
    dontsEn: ['Hold grudges', 'Restart old conflict'], dontsSi: ['තරහවල් හිතේ තියාගෙන තැවෙන්න එපා', 'ඉවෙර වෙච්ච පරණ ප්‍රශ්න ආයේ අදින්න යන්න එපා'],
  },
};
...
var PRACTICAL_GUIDES = {
  ...
  nakshatra: {
    ...
    Dhanishtha: ['Drumbeat of Destiny', 'සාර්ථකත්වයේ رිද්මය', 'social'], Shatabhisha: ['100 Healing Veils', 'සුවය සහ සහනය ළඟා වීම', 'heal'],
  ...
  yoga: {
    ...
    Vyatipata: ['A Sudden Shift', 'අනපේක්ෂිත වෙනස්කම්වලට සූදානම් වීම', 'caution'], Variyan: ['Silken Pace', 'සැහැල්ලු සහ විවේකී කාලයක්', 'rest'],
  ...
  karana: {
    ...
    Garaja: ['The Quiet Worker', 'නිහඬව වගකීම් ඉටුකිරීම', 'discipline'], Vanija: ['The Golden Trade', 'ගනුදෙනුවලට සුබදායක වීම', 'money'],
...
var ORACLE_LAGNA_ARCHETYPES = {
  Mesha: {
    ...
    traitSi: 'ඔයාට මාරම ශක්තියක් තියෙන්නේ, හැබැයි හැමදේටම කලබල වුණොත් ඉක්මනටම මහන්සි වෙයි. අද දවසේ ගැඹුරින් හුස්මක් අරන්, වැදගත්ම එක ඉලක්කයක් විතරක් තෝරගෙන ඔයාගේ උපරිම ශක්තිය ඒකට විතරක් යොදවන්න.',
  },
  Vrishabha: {
    titleEn: 'Steady Growth',
    titleSi: 'ස්ථාවර වර්ධනයක්',
    ...
    traitSi: 'ඉදිරියට යන්න නම් හැමදේම එකපාර වෙනස් කරන්න ඕනම නැහැ. ඔයා හෙමින් හැබැයි ස්ථාවරව තියන පියවර ගැන විශ්වාස කරන්න. මොකද ගහකට වුණත් ශක්තිමත් මුල් විහිදන්න ටිකක් කල් යනවා.',
  },
  Mithuna: {
    titleEn: 'Quiet Focus',
    titleSi: 'නිහඬ අවධානයක්',
    ...
    traitSi: 'ඔයාගේ දක්ෂ මනස නිතරම අලුත් අදහස් හෙව්වත්, අද ඒකට පොඩි විවේකයක් ඕන කරනවා. වැඩක් නැති දේවල් අතඇරලා දාලා, ඔයාට ඇත්තටම සතුටක් දෙන දේට විතරක් අද සම්පූර්ණ අවධානය දෙන්න.',
  },
  Kataka: {
    titleEn: 'Gentle Strength',
    titleSi: 'මෘදු ශක්තියක්',
    ...
    traitSi: 'අනිත් අය ගැන ඕනෑවටත් වඩා හොයලා බලන එක ඔයාගේ තියන හොඳම ගුණයයි, හැබැයි ඒ අතරේ ඔයා ඔයා ගැනත් බලාගන්න ඕනේ. සමහර වෙලාවට බැහැ කියන එකයි, තමන්ගේ හිතේ නිදහස රැකගන්න එකයි කිසිම වරදක් නෙවෙයි.',
  },
  Simha: {
    titleEn: 'Quiet Confidence',
    titleSi: 'නිහඬ ආත්ම විශ්වාසයක්',
    ...
    traitSi: 'ඔයාගේ වටිනාකම පෙන්නන්න කාගෙන්වත් අප්පුඩියක් බලාපොරොත්තු වෙන්න එපා, මොකද ඔයා දැනටමත් ලස්සනට බබළනවා. කවුරුත් බලාගෙන හිටියේ නැතත් හැමෝම එක්ක කරුණාවෙන්, ආදරෙන් ඉන්න එකයි අද දවසේ නියම නායකත්වය.',
  },
  Kanya: {
    titleEn: 'Mindful Grace',
    titleSi: 'සිහියෙන් යුතු කරුණාවක්',
    ...
    traitSi: 'ඔයා හැමදේම පරිපූර්ණව කරන්න උත්සාහ කරන කෙනෙක්, හැබැයි වැරදීම් කියන්නේ අපි දේවල් ඉගෙන ගන්න විදිහ කියලා මතක තියාගන්න. අද ඔයාටම ටිකක් මෘදු වෙන්න, ඔයා ලස්සනට කරන පුංචි පුංචි දේවල් අගය කරන්න.',
  },
  Tula: {
    titleEn: 'Inner Harmony',
    titleSi: 'හිතේ සමතුලිතතාවය',
    ...
    traitSi: 'හැමෝම සතුටින් තියන්න හදන එක දවස ගානේ උස්සන් ඉන්න අමාරු බරක්. පොඩ්ඩක් නතර වෙලා ඔයාගේ හදවතට ඇත්තටම ඕන මොකක්ද කියලා අහන්න, තනියම ඉන්න වෙලාවත් සතුටින් විඳින්න.',
  },
  Vrischika: {
    titleEn: 'Peaceful Trust',
    titleSi: 'සාමකාමී විශ්වාසයක්',
    ...
    traitSi: 'ඔයාගේ හැඟීම් ගොඩක් ගැඹුරුයි, ඒ නිසාම සමහර වෙලාවට ජීවිතේ ගලාගෙන යන විදිහ විශ්වාස කරන්න අමාරු ඇති. අද දවසේ හැමදේම පාලනය කරන්න හදන්නේ නැතුව, ලස්සන දේවල් ඔයා හොයාගෙන එයි කියලා විශ්වාස කරන්න.',
  },
  Dhanus: {
    titleEn: 'Joyful Journey',
    titleSi: 'සතුටුදායක ගමනක්',
    ...
    traitSi: 'ඔයා හැමවෙලේම බලන්නේ අනාගතයේ තියන ඊළඟ ලොකු ඇඩ්වෙන්චර් එක දිහායි. හැබැයි මේ වෙලාවේ ඔයා ඉන්න තැන තියන සරල සුන්දරත්වය දැකලා හිනාවෙන්නත් අමතක කරන්න එපා.',
  },
  Makara: {
    titleEn: 'Gentle Patience',
    titleSi: 'මෘදු ඉවසීමක්',
    ...
    traitSi: 'ඔයා කිසිම මැසිවිල්ලක් නැතුව මාරම මහන්සියකින් ලොකු වගකීම් දරන කෙනෙක්. හැබැයි මතක තියාගන්න, විවේක ගන්නවා කියන්නේ කාලය නාස්ති කිරීමක් නෙවෙයි, ඒක ඔයාගේ ලස්සන අනාගතයට ශක්තිය එකතු කරගැනීමක්.',
  },
  Kumbha: {
    titleEn: 'Open Heart',
    titleSi: 'විවෘත හදවතක්',
    ...
    traitSi: 'ඔයාගේ හිත හැමවෙලේම කාර්යබහුල වෙලා තියෙන්නේ ලෝකය යහපත් කරන්න පුළුවන් විදි ගැන හිතමින්. අද දවසේ ඒ ලස්සන හීන ඔයාගේ වටපිටාවටත් අරන් ඇවිත්, ළඟ ඉන්න කෙනෙක්ට පුංචි, උණුසුම් සිනහවක් තෑගි කරන්න.',
  },
  Meena: {
    titleEn: 'Clear Water',
    titleSi: 'පැහැදිලි දියඹක්',
    ...
    traitSi: 'ඔයා වටේ ඉන්න අයගේ දුක, සතුට හැමදේම ඔයාගේ හිතටත් ඒ විදිහටම දැනෙනවා. අද දවසේ ඔයාගේ වටේ පොඩි සීමාවක් හදාගන්න, එතකොට ඔයාගේ ඇතුළේ තියන සතුට රැකගෙන හිත නිදහසේ තියාගන්න පුළුවන් වෙයි.',
  },
};
...
var DEFAULT_ORACLE_ARCHETYPE = {
  ...
  traitSi: 'සෑම හිරු උදාවකින්ම ඔයාගේ කතාව අලුතින්ම ලියන්න හිස් පිටුවක් ලැබෙනවා. ගැඹුරින් හුස්මක් අරන්, උදෑසන එළියට හිනාවෙලා, නිදහස් හිතකින් අද දවසට පියනගන්න.',
};
...
function FutureWindowsBait() {
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={function () { showPaywall('home_future_windows'); }}
...
var AuraScores = React.memo(function AuraScores({ result, language }) {
        ...
        <View style={aur.row}>
          <View style={aur.chartWrap}>
            ...
            <View style={aur.centerOverlay} pointerEvents="none">
              <Text style={[aur.overallNum, { color: overallColor }]}>{result.overall}</Text>
            ...
            {scores.map(function (a, i) {
              return (
                <Animated.View key={a.key} entering={FadeInUp.delay(360 + i * 45).springify()} style={aur.legRow}>
                  ...
                  <Text style={aur.legName}>{a.label}</Text>
                  ...
                  <View style={[aur.legScorePill, { backgroundColor: a.color + '14', borderColor: a.color + '30' }]}>
                    <Text style={[aur.legScore, { color: a.color }]}>{a.score}</Text>
                  </View>
                </Animated.View>
              );
            })}
      ...
      <View style={sky.card}>
        ...
        <View style={sky.arcWrap}>
          <Svg width="100%" height="100%" viewBox="0 0 360 170" preserveAspectRatio="none">
            <Defs>
              <SvgLinearGradient id="skyArcGrad" x1="0" y1="0" x2="1" y2="0">
                <Stop offset="0" stopColor="#F08C4A" stopOpacity="0.9" />
            ...
            {/* auspicious window — golden light */}
            {auspD ? (
              <G>
                <Path d={auspD} fill="none" stroke="rgba(255,217,131,0.26)" strokeWidth="12" strokeLinecap="round" />
                <Path d={auspD} fill="none" stroke="#FFE9A8" strokeWidth="4" strokeLinecap="round" />
              </G>
            ) : null}
            {/* Rahu Kalaya — danger band */}
            {rahuD ? (
              <G>
                <Path d={rahuD} fill="none" stroke="rgba(252,120,120,0.22)" strokeWidth="12" strokeLinecap="round" />
                <Path d={rahuD} fill="none" stroke="#F87171" strokeWidth="4" strokeLinecap="round" />
              </G>
            ) : null}
            {/* horizon */}
          ...
          <View style={[sky.nowWrap, { left: (nowPt.x / 360 * 100) + '%', top: (nowPt.y / 170 * 100) + '%' }]} pointerEvents="none">
            <View style={sky.nowBadge}><Text style={sky.nowBadgeText}>{(language === 'si' ? 'දැන් ' : 'Now ') + fmtHM(nowMs, t)}</Text></View>
            <View style={sky.sunBox}>
              <Animated.View style={[sky.sunHalo, isNight && sky.sunHaloNight, haloStyle]} />
        ...
        <View style={sky.footer}>
          {showAusp ? (
            <View style={sky.legChip}>
              <View style={[sky.legDot, { backgroundColor: '#FFE9A8' }]} />
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text style={sky.legChipLabel}>{language === 'si' ? 'සුබ වේලාව' : 'AUSPICIOUS'}</Text>
                <Text style={sky.legChipTime} numberOfLines={1}>{fmtHM(apStart, t) + ' – ' + fmtHM(apEnd, t)}</Text>
              </View>
            </View>
          ) : null}
          {showRahu ? (
            <View style={[sky.legChip, rahuActive && sky.legChipDanger]}>
              <View style={[sky.legDot, { backgroundColor: '#F87171' }]} />
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text style={sky.legChipLabel}>{language === 'si' ? 'රාහු කාලය' : 'RAHU KALAYA'}</Text>
        ...
        <View style={sky.progressRow}>
          <View style={sky.progressTrack}>
            <LinearGradient colors={['#F08C4A', '#FFE9A8']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[sky.progressFill, { width: Math.max(2, dayPct) + '%' }]} />
          </View>
...
export default function HomeScreen() {
  ...
  function renderDailyMantra() {
    ...
    var mantrasSi = [
  'මගේ හැකියාවන්ට කිසිම සීමාවක් නැහැ. අදත් මම මගේ අරමුණු වෙනුවෙන් එක පියවරක් හරි ඉස්සරහට තියනවා.',
  'අද දවස මට අලුත් අවස්ථා ගොඩක් අරගෙන එනවා. මම ඒ හැමදේටම ලෑස්තියි.',
  'මගේ ජීවිතේට වර්ධනය, සැනසීම වගේම ඇත්තටම වටින ජයග්‍රහණ විතරක් මම ළං කරගන්නවා.',
  'මගේ හිත කියන දේ මාව හරි පාරට අරන් යන ලොකුම මාලිමාව කියලා මම දන්නවා.',
  'බය, සැක ඔක්කොම අයින් කරලා, හිතේ මාරම පැහැදිලි බවක් සහ විශ්වාසයක් ඇතුව මම ඉස්සරහට යනවා.',
  'විශ්වයේ රිද්මයත් එක්ක මගේ ගමනත් දැන් සමබරයි. අද දවසේ මොනවා වුණත් මම ඒ හැමදේටම ලෑස්තියි.',
  'කලබලකාරී හැමදේම පැත්තකින් තියලා, මම අද දවස හරිම නිදහසෙන් ගෙවනවා.',
  'මගේ ජීවිතේට හොඳම දේවල් ලැබෙන්න නියමිතයි කියලා දන්න නිසා, මම ලොකු විශ්වාසෙකින් ඉන්නවා.',
  'ජීවිතේ වෙනස් කරන සුපිරි අවස්ථා සහ අලුත්, වැදගත් සබඳතාවලට මගේ හිත හැමවෙලේම විවෘතයි.',
  'මගේ හිනාවයි ධනාත්මක බවයි මට හමුවෙන හැමෝටම ලොකු හයියක් වෙනවා.',
  'ජීවිතේට එන ඕනෙම වෙනස්වීමක්, කරුණාවෙන් සහ ධෛර්යයෙන් පිළිගන්න මට පුළුවන්.',
  'මම මුහුණදෙන හැම අභියෝගයක්ම මාව ඊට වඩා ලොකු ජයග්‍රහණයකට ලෑස්ති කරනවා.',
  'ආත්ම විශ්වාසය, ආත්ම ගෞරවය වගේම හිතේ නිදහස අද මගෙන් ලෝකෙටම පේන්න විහිදෙනවා.',
  'මම යන්න ඕන පාර මට මාරම පැහැදිලියි. කිසිම බයක් නැතුව මම ඒ පාරේ අඩිය තියනවා.',
  'මගේ ඇතුළෙම තියෙන ශක්තියයි දැනුමයි එක්ක, ඉස්සරහට ලැබෙන හැම සුපිරි අවස්ථාවක්ම මම මගේ කරගන්නවා.',
];
        ...
        >
          ...
          {data && !loading && (
            <View style={[s.todayStack, isDesktop && s.todayStackDesktop]}>
              {/* ── 1. Conversion bait (free users) ── */}
              <FutureWindowsBait />

              {/* ── 2. Living Sky Hero — the single anchor ── */}
              {renderOracleHero()}

              {/* ── 3. SIGNATURE: live day sun-clock (merges Rahu + Auspicious + sunrise/sunset) ── */}
              <DaySkyClock data={data} language={language} t={t} skipHeavy={skipHeavy} />

              {/* ── 4. Your Day, Scored — real personalized aura (replaces fake ratings + lucky numbers) ── */}
              <AuraScores result={computeLifeScores(chartData, jyotishToday, data, language)} language={language} />

              {/* ── 5. Cosmic Shield + real yogas ── */}
              {hasBirthData && renderCosmicShield()}
              {hasBirthData && renderTodayYogas()}

              {/* ── 6. Moon Phase Showcase ── */}
              {renderMoonPhaseCard()}

              {/* ── 7. Today's Focus — one merged inspiration surface ── */}
              {hasBirthData ? (
                <AffirmationCard
                  language={language}
                  birthDate={birthDateTime}
              ...
              {/* ── 8. Cosmic Detail (Panchanga accordion) ── */}
              {renderPanchanga()}
...
var aur = StyleSheet.create({
  ...
  chartWrap: { width: 166, height: 166, position: 'relative' },
  centerOverlay: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center' },
  overallNum: { fontSize: 32, fontWeight: '900', lineHeight: 34, fontVariant: ['tabular-nums'], ...textShadow('rgba(232,197,106,0.35)', { width: 0, height: 0 }, 12) },
  overallLbl: { fontSize: 8.5, letterSpacing: 1.6, color: 'rgba(244,238,223,0.42)', fontWeight: '800', marginTop: 2 },
  legend: { flex: 1, gap: 9 },
  ...
  legName: { fontSize: 11, fontWeight: '600', color: 'rgba(244,238,223,0.72)', width: 46 },
  ...
  legScorePill: { minWidth: 30, borderRadius: 8, borderWidth: 1, paddingHorizontal: 5, paddingVertical: 2, alignItems: 'center' },
  legScore: { fontSize: 11.5, fontWeight: '800', fontVariant: ['tabular-nums'] },
...
var sky = StyleSheet.create({
  ...
  legChipDanger: { backgroundColor: 'rgba(252,120,120,0.08)', borderColor: 'rgba(252,120,120,0.25)' },
