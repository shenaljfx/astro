...
// ── "Gilded Shadow-Box Jianzhi" — the app-wide dusk theme. Deep midnight
//    indigo paper, antique-gold hairlines and type, with peacock-teal and
//    lotus-magenta as the jewel backlight accents. Every surface should read
//    as a lit cut-paper layer, never a flat grey card.
const _duskPalette = {
  mode: 'dusk',
  // Backgrounds — deep midnight indigo (the shadow-box interior)
  bg: '#0A0714',
  bgMid: '#150E2E',
  bgDeep: '#06040E',
  surface: '#1E1440',
  surfaceMuted: '#160E32',
  surfaceElevated: '#2B1D54',
  surfacePressed: '#120B28',
  // Brand — violet paper
  primary: '#B39CE8',
  primaryLight: '#D4C7FF',
  primaryDark: '#7C5BD6',
  primaryMuted: 'rgba(179,156,232,0.15)',
  primaryGlow: 'rgba(179,156,232,0.30)',
  // Accent — antique gold foil
  accent: '#E8B54D',
  accentLight: '#F6D584',
  accentDark: '#B8863A',
  accentMuted: 'rgba(232,181,77,0.16)',
  accentGlow: 'rgba(232,181,77,0.34)',
  // Sage / jewel teal
  sage: '#3FB6C6',
  sageMuted: 'rgba(63,182,198,0.15)',
  // Text — warm parchment on indigo
  text: '#F4EAD0',
  textPrimary: '#F4EAD0',
  textSecondary: 'rgba(244,234,208,0.78)',
  textMuted: 'rgba(244,234,208,0.52)',
  textAccent: '#F6D584',
  textOnAccent: '#2A1707',
  textDisabled: 'rgba(244,234,208,0.30)',
  // Borders — gold hairlines, not grey
  border: 'rgba(232,181,77,0.16)',
  borderLight: 'rgba(232,181,77,0.26)',
  borderFocus: 'rgba(246,213,132,0.55)',
  borderAccent: 'rgba(232,181,77,0.40)',
  // Glass (indigo frosted)
  glass: 'rgba(22,15,44,0.68)',
  glassBorder: 'rgba(232,181,77,0.18)',
  glassHighlight: 'rgba(246,213,132,0.08)',
  // Status
  success: '#3FB6C6',
  warning: '#E8B54D',
  danger: '#E0768C',
  ...
  cosmicRose: '#C2477E',
  auroraGreen: '#3FB6C6',
  cardGlow: 'rgba(232,181,77,0.14)',
  cardBorderHero: 'rgba(232,181,77,0.42)',
  cardBorderContent: 'rgba(232,181,77,0.22)',
  backgroundCard: 'rgba(30,20,64,0.70)',
  backgroundCardHover: 'rgba(43,29,84,0.78)',
  backgroundInput: 'rgba(22,14,50,0.72)',
  backgroundModal: 'rgba(10,7,20,0.96)',
  buttonPrimary: '#E8B54D',
  buttonPrimaryLight: '#F6D584',
  buttonPrimaryDark: '#B8863A',
  buttonGlow: 'rgba(232,181,77,0.55)',
  buttonBorder: 'rgba(246,213,132,0.40)',
  ...
  goldDark: '#B8863A',
  goldShimmer: '#F6D584',
  goldMuted: 'rgba(232,181,77,0.16)',
  goldGlow: 'rgba(232,181,77,0.26)',
  goldBorder: 'rgba(232,181,77,0.22)',
  goldSubtle: 'rgba(232,181,77,0.07)',
  textGold: '#F6D584',
  textLight: '#B8863A',
  successBg: 'rgba(63,182,198,0.13)',
  dangerBg: 'rgba(224,118,140,0.13)',
  warningBg: 'rgba(232,181,77,0.13)',
  purple: '#B39CE8',
  purpleBg: 'rgba(179,156,232,0.13)',
  blue: '#8AA8E0',
  blueBg: 'rgba(138,168,224,0.12)',
  rose: '#C2477E',
  roseBg: 'rgba(194,71,126,0.14)',
  tealBg: 'rgba(63,182,198,0.13)',
  shadow: 'rgba(232,181,77,0.18)',
  divider: 'rgba(232,181,77,0.14)',
  // Rahu
  rahuActive: '#E0768C',
  rahuInactive: '#3FB6C6',
  // Scores
  scoreExcellent: '#3FB6C6',
  scoreGood: '#8AA8E0',
  scoreAverage: '#E8B54D',
  scorePoor: '#E0768C',
};
