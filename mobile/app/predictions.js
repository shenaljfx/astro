...
var s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 20, fontWeight: '700', color: '#FFF1D0', letterSpacing: 0.5 },
  ...
  eventName: { flex: 1, fontSize: 15, fontWeight: '600', color: '#FFF1D0' },
  ...
  transitPlanet: { width: 70, fontSize: 14, fontWeight: '600', color: '#FFF1D0' },
  ...
  annualYear: { fontSize: 24, fontWeight: '700', color: '#FFF1D0' },
  ...
  dashLord: { fontSize: 13, color: '#FFF1D0', fontWeight: '600' },
