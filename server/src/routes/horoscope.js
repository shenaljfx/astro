...
router.get('/birth-chart/data', async (req, res) => {
  try {
    ...
    res.json({
        success: true,
        data: {
            houseChart: houses,           // House-ordered (house 1 = lagna rashi)
            rashiChart: houses,           // Same data, for backward compat
            navamshaChart: navamshaChart.houses,
